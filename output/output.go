...
type ProxyCategory struct {
	...
	Filter  func(result checker.Result) bool
}
...
func NewConfigSaver(results []checker.Result) *ConfigSaver {
	return &ConfigSaver{
		results:    results,
		...
		categories: []ProxyCategory{
			{
				...
				Filter:  func(result checker.Result) bool { return true },
			},
		},
	}
}
...
func SaveConfig(results []checker.Result) {
